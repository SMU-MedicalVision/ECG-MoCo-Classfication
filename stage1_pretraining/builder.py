...
class MoCo(nn.Module):
    ...
    def __init__(self, base_encoder, dim=128, K=65536, m=0.999, T=0.07, ratio=0.14):
    ...
    def forward(self, im_q, im_k, img_s_list):
        ...
        loss_distribute = self.ratio * loss_ddm
        # dequeue and enqueue
        self._dequeue_and_enqueue(k)

        return logits, labels, loss_contrastive, loss_distribute
